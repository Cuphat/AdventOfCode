...
namespace AdventOfCode2017_CSharp
{
    internal static partial class Program
    {
        ...
        private class StreamProcessor
        {
            ...
            public StreamGroup OuterGroup { get; private set; }
            public int GarbageCharacters { get; private set; }
            ...
            private void ProcessStream()
            {
                ...
                foreach (var c in Input)
                {
                    ...
                    if (c == '{')
                    {
                        ...
                        if (OuterGroup == null) OuterGroup = newGroup;
                    ...
                    {
                        currentGroups.Pop();
                        if (!currentGroups.TryPeek(out currentGroup)) currentGroup = null;
                        continue;
                    }
        ...
        private static void Day9(string input)
        {
            var streamProcessor = new StreamProcessor(input);
            var score = streamProcessor.OuterGroup.CalculateScore(1);
            Console.WriteLine($"Score calculated: {score}");
            Console.WriteLine($"Garbage characters: {streamProcessor.GarbageCharacters}");
        }
    }
}
